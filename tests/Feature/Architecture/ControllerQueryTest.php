...
class ControllerQueryTest extends TestCase
{
    ...
    private const OFFENDERS = [
        ...
        'Api/V1/HR/ShiftController.php' => 6,
        ...
        'Api/V1/Manufacturing/CalibrationController.php' => 13,

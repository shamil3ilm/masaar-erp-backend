...
class CounterBasedPlan extends Model
{
    use HasUuid;
    ...
    {
        return $this->belongsTo(EquipmentCounter::class, 'counter_id');
    }
    ...
    {
        return $this->hasMany(CounterBasedOrder::class, 'maintenance_plan_id');
    }
}

...
class BahrainVatReturn extends Model
{
    ...
    protected $casts = [
        'standard_rated_supplies'  => 'decimal:4',
        'zero_rated_supplies'      => 'decimal:4',
        'exempt_supplies'          => 'decimal:4',
        'output_vat'               => 'decimal:4',
        'standard_rated_purchases' => 'decimal:4',
        'capital_goods_input_tax'  => 'decimal:4',
        'total_input_vat'          => 'decimal:4',
        'net_vat_payable'          => 'decimal:4',
        'vat_rate'                 => 'decimal:4',
        'period_start'             => 'date',
        'period_end'               => 'date',

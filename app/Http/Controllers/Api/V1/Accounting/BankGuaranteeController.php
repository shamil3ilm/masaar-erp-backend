...
class BankGuaranteeController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'bank_id'                    => ['nullable', $this->ownedBy('contacts')],
            'beneficiary_id'             => ['nullable', $this->ownedBy('contacts')],
            'applicant_id'               => ['nullable', $this->ownedBy('contacts')],
            'related_purchase_order_id'  => ['nullable', $this->ownedBy('purchase_orders')],
            'related_sales_order_id'     => ['nullable', $this->ownedBy('sales_orders')],

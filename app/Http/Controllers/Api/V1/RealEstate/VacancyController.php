...
class VacancyController extends Controller
{
    ...
    public function vacate(Request $request, string $id): JsonResponse
    {
        ...
        return $this->success($vacancy, 'Vacancy period opened', 201);
    }
    ...
    /**
     * Occupancy over time, for one building or for all of them.
     *
     * Two routes reach this: /buildings/{buildingId}/occupancy-trend, which
     * names a building, and /reports/occupancy-trend, which does not.
     */
    public function occupancyTrend(Request $request, ?string $buildingId = null): JsonResponse
    {
        $validated = $request->validate([
            'from' => 'required|date',
        ...
        $trend = $this->service->getOccupancyTrend(
            $buildingId !== null ? (int) $buildingId : null,

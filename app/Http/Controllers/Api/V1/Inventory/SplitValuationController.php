...
class SplitValuationController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return $this->success($splits, 'Split valuations retrieved');
    }
    ...
    public function createCategory(Request $request): JsonResponse
    {
        ...
        return $this->success($category, 'Valuation category created', 201);
    }
    ...
    public function createType(Request $request, ValuationCategory $category): JsonResponse
    {
        ...
        return $this->success($type, 'Valuation type created', 201);
    }
    ...
    public function goodsReceipt(Request $request): JsonResponse
    {
        ...
        return $this->success($split, 'Goods receipt posted to split valuation', 201);
    }
    ...
    public function goodsIssue(Request $request): JsonResponse
    {
        ...
        return $this->success($split, 'Goods issue posted to split valuation');
    }
    ...
    public function revaluate(Request $request): JsonResponse
    {
        ...
        return $this->success($result, 'Split valuation price revaluation applied');
    }
}

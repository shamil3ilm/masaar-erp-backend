...
class PersonnelActionController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return $this->success($query->latest()->paginate(25));
    }
    ...
    public function submit(string $id): JsonResponse
    {
        ...
        return $this->success($updated, 'Personnel action submitted for approval');
    }
    ...
    public function approve(Request $request, string $id): JsonResponse
    {
        ...
        return $this->success($updated->load('steps'), 'Personnel action approved and executed');
    }
    ...
    public function reject(Request $request, string $id): JsonResponse
    {
        ...
        return $this->success($updated, 'Personnel action rejected');
    }
    ...
    public function reverse(Request $request, string $id): JsonResponse
    {
        ...
        return $this->success($updated, 'Personnel action reversed');
    }
}

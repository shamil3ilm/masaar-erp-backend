...
Route::apiResource('condition-rules', ConditionMaintenanceController::class)->names('maintenance.condition-rules')->middlewareFor(['store', 'update', 'destroy'], 'check.permission:maintenance.condition-rules.manage');

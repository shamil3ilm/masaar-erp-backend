...
Route::middleware(['auth:api'])->group(function () {
    ...
    */
    Route::prefix('cpq')->name('sales.cpq.')->group(function (): void {
        Route::get('/products', [CpqController::class, 'products'])->name('products')->middleware('check.permission:sales.cpq.view');
        Route::post('/products', [CpqController::class, 'storeProduct'])->name('products.store')->middleware('check.permission:sales.cpq.manage');
        Route::get('/products/{id}', [CpqController::class, 'showProduct'])->name('products.show')->middleware('check.permission:sales.cpq.view');
        ...
        Route::get('/products/{productId}/option-groups', [CpqController::class, 'optionGroups'])->name('option-groups')->middleware('check.permission:sales.cpq.view');
        ...
        Route::get('/products/{productId}/pricing-rules', [CpqController::class, 'pricingRules'])->name('pricing-rules')->middleware('check.permission:sales.cpq.view');
        ...
        Route::get('/products/{productId}/constraint-rules', [CpqController::class, 'constraintRules'])->name('constraint-rules')->middleware('check.permission:sales.cpq.view');
        ...
        Route::get('/configurations', [CpqController::class, 'configurations'])->name('configurations')->middleware('check.permission:sales.cpq.view');
        ...
        Route::get('/configurations/{id}', [CpqController::class, 'showConfiguration'])->name('configurations.show')->middleware('check.permission:sales.cpq.view');
...
Route::middleware(['auth:api'])->prefix('order-costing')->name('sd.order-costing.')->group(function () {
    Route::get('/', [SalesOrderCostingController::class, 'index'])->name('index')->middleware('check.permission:sales.order-costing.view');
    Route::post('/', [SalesOrderCostingController::class, 'store'])->name('store')->middleware('check.permission:sales.order-costing.manage');
    Route::get('/{id}', [SalesOrderCostingController::class, 'show'])->name('show')->middleware('check.permission:sales.order-costing.view');
...
Route::middleware(['auth:api'])->prefix('billing-plans')->name('sd.billing-plans.')->group(function (): void {
    Route::get('/', [BillingPlanController::class, 'index'])->name('index')->middleware('check.permission:sales.billing-plans.view');
    Route::post('/', [BillingPlanController::class, 'store'])->name('store')->middleware('check.permission:sales.billing-plans.manage');
    Route::get('/due-items', [BillingPlanController::class, 'dueItems'])->name('due-items')->middleware('check.permission:sales.billing-plans.view');
    Route::get('/{id}', [BillingPlanController::class, 'show'])->name('show')->middleware('check.permission:sales.billing-plans.view');
...
Route::middleware(['auth:api'])->prefix('backorders')->name('sd.backorders.')->group(function (): void {
    Route::get('/', [BackorderController::class, 'index'])->name('index')->middleware('check.permission:sales.backorders.view');
    Route::post('/', [BackorderController::class, 'store'])->name('store')->middleware('check.permission:sales.backorders.manage');
    Route::get('/report', [BackorderController::class, 'report'])->name('report')->middleware('check.permission:sales.backorders.view');
    Route::get('/{id}', [BackorderController::class, 'show'])->name('show')->middleware('check.permission:sales.backorders.view');
...
Route::middleware(['auth:api'])->prefix('third-party-orders')->name('sd.tpo.')->group(function (): void {
    Route::get('/', [ThirdPartyOrderController::class, 'index'])->name('index')->middleware('check.permission:sales.third-party-orders.view');
    Route::post('/', [ThirdPartyOrderController::class, 'store'])->name('store')->middleware('check.permission:sales.third-party-orders.manage');
    Route::get('/{id}', [ThirdPartyOrderController::class, 'show'])->name('show')->middleware('check.permission:sales.third-party-orders.view');
...
Route::middleware(['auth:api'])->prefix('shipping-zones')->name('sd.shipping-zones.')->group(function (): void {
    Route::get('/', [ShippingRouteController::class, 'zoneIndex'])->name('index')->middleware('check.permission:sales.shipping-routes.view');
    Route::post('/', [ShippingRouteController::class, 'zoneStore'])->name('store')->middleware('check.permission:sales.shipping-zones.manage');
    Route::get('/{id}', [ShippingRouteController::class, 'zoneShow'])->name('show')->middleware('check.permission:sales.shipping-routes.view');
...
Route::middleware(['auth:api'])->prefix('shipping-routes')->name('sd.shipping-routes.')->group(function (): void {
    Route::get('/', [ShippingRouteController::class, 'routeIndex'])->name('index')->middleware('check.permission:sales.shipping-routes.view');
    Route::post('/', [ShippingRouteController::class, 'routeStore'])->name('store')->middleware('check.permission:sales.shipping-routes.manage');
    Route::get('/{id}', [ShippingRouteController::class, 'routeShow'])->name('show')->middleware('check.permission:sales.shipping-routes.view');
...
Route::middleware(['auth:api'])->prefix('handling-units')->name('sd.handling-units.')->group(function (): void {
    Route::get('/', [HandlingUnitController::class, 'index'])->name('index')->middleware('check.permission:sales.handling-units.view');
    Route::post('/', [HandlingUnitController::class, 'store'])->name('store')->middleware('check.permission:sales.handling-units.manage');
    Route::get('/{id}', [HandlingUnitController::class, 'show'])->name('show')->middleware('check.permission:sales.handling-units.view');
    ...
    Route::get('/packing-list/{shipmentId}', [HandlingUnitController::class, 'packingList'])->name('packing-list')->middleware('check.permission:sales.handling-units.view');
});
...
Route::middleware(['auth:api'])->prefix('billing-due-list')->name('sd.billing-due-list.')->group(function (): void {
    Route::get('/', [BillingDueListController::class, 'index'])->name('index')->middleware('check.permission:sales.billing-due-list.view');
...
Route::middleware(['auth:api'])->prefix('rebates')->name('sd.rebates.')->group(function (): void {
    Route::get('/', [RebateController::class, 'index'])->name('index')->middleware('check.permission:sales.rebates.view');
    Route::post('/', [RebateController::class, 'store'])->name('store')->middleware('check.permission:sales.rebates.manage');
    Route::get('/{rebate}', [RebateController::class, 'show'])->name('show')->middleware('check.permission:sales.rebates.view');
    Route::put('/{rebate}', [RebateController::class, 'update'])->name('update')->middleware('check.permission:sales.rebates.manage');
    Route::get('/{rebate}/balance', [RebateController::class, 'balance'])->name('balance')->middleware('check.permission:sales.rebates.view');

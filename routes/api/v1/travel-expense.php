...
Route::prefix('travel')->group(function (): void {
    ...
    Route::apiResource('per-diem-rates', TravelExpenseController::class)
        ->names('hr.per-diem-rates')->middlewareFor(['store', 'update', 'destroy'], 'check.permission:hr.travel.manage');
    ...
    Route::apiResource('requests', TravelExpenseController::class)
        ->names('hr.travel-requests')->middlewareFor(['store', 'update', 'destroy'], 'check.permission:hr.travel.manage');
    ...
    Route::apiResource('claims', TravelExpenseController::class)
        ->names('hr.travel-claims')->middlewareFor(['store', 'update', 'destroy'], 'check.permission:hr.travel.manage');

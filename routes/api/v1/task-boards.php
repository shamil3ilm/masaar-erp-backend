...
use Illuminate\Support\Facades\Route;
    ...
    Route::apiResource('boards', TaskBoardController::class)->except(['store'])
        ...
        ->middlewareFor(['destroy'], 'check.permission:taskboard.boards.delete')->middlewareFor(['index', 'show'], 'check.permission:taskboard.boards.view');
    ...
    Route::get('boards/{board}/labels', [TaskBoardController::class, 'labels'])->middleware('check.permission:taskboard.boards.view');
    ...
    Route::prefix('boards/{board}/tasks')->group(function () {
        Route::get('/', [BoardTaskController::class, 'index'])->middleware('check.permission:taskboard.tasks.view');
        Route::post('/', [BoardTaskController::class, 'store'])->middleware('check.permission:taskboard.tasks.create');
        Route::get('/{task}', [BoardTaskController::class, 'show'])->middleware('check.permission:taskboard.tasks.view');
    ...
    Route::prefix('sprints')->group(function () {
        Route::get('/', [SprintController::class, 'index'])->middleware('check.permission:taskboard.sprints.view');
        Route::post('/', [SprintController::class, 'store'])->middleware('check.permission:taskboard.sprints.create');
        Route::get('/{sprint}', [SprintController::class, 'show'])->middleware('check.permission:taskboard.sprints.view');
        ...
        Route::get('/{sprint}/burndown', [SprintController::class, 'burndownChart'])->middleware('check.permission:taskboard.sprints.view');
    });

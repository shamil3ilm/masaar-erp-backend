...
Route::get('/currencies', [MultiCurrencyController::class, 'currencies'])->middleware('check.permission:accounting.multi-currency.view');
...
Route::prefix('revaluations')->group(function () {
    Route::get('/', [MultiCurrencyController::class, 'revaluations'])->middleware('check.permission:accounting.multi-currency.view');
    ...
    Route::get('/{currencyRevaluation}', [MultiCurrencyController::class, 'showRevaluation'])->middleware('check.permission:accounting.multi-currency.view');
...
// Forex Reports
Route::get('/forex-report', [MultiCurrencyController::class, 'forexReport'])->middleware('check.permission:accounting.multi-currency.view');

...
Route::get('procedures', [PricingConditionController::class, 'indexProcedures'])->name('sales.pricing.procedures.index')->middleware('check.permission:sales.pricing.view');
...
Route::get('procedures/{pricingProcedure}', [PricingConditionController::class, 'showProcedure'])->name('sales.pricing.procedures.show')->middleware('check.permission:sales.pricing.view');
...
Route::get('condition-types', [PricingConditionController::class, 'indexConditionTypes'])->name('sales.pricing.condition-types.index')->middleware('check.permission:sales.pricing.view');
...
Route::get('condition-types/{pricingConditionType}', [PricingConditionController::class, 'showConditionType'])->name('sales.pricing.condition-types.show')->middleware('check.permission:sales.pricing.view');
...
Route::get('condition-records', [PricingConditionController::class, 'indexConditionRecords'])->name('sales.pricing.condition-records.index')->middleware('check.permission:sales.pricing.view');
...
Route::get('condition-records/{pricingConditionRecord}', [PricingConditionController::class, 'showConditionRecord'])->name('sales.pricing.condition-records.show')->middleware('check.permission:sales.pricing.view');

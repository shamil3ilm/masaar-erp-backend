...
Route::apiResource('transfer-orders', WarehouseTransferOrderController::class)->parameters(['transfer-orders' => 'warehouseTransferOrder'])->names('inventory.transfer-orders')->middlewareFor(['store', 'update', 'destroy'], 'check.permission:inventory.transfer-orders.manage')->middlewareFor(['index', 'show'], 'check.permission:inventory.transfer-orders.view');

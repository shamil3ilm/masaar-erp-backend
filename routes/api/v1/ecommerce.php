...
Route::middleware(['auth:api'])->group(function () {
    ...
    */
    Route::prefix('channels')->group(function () {
        Route::get('/', [EcommerceChannelController::class, 'index'])->name('ecommerce.channels.index')->middleware('check.permission:ecommerce.channels.view');
        ...
        Route::get('/{ecommerceChannel}', [EcommerceChannelController::class, 'show'])->name('ecommerce.channels.show')->middleware('check.permission:ecommerce.channels.view');
        ...
        Route::get('/{ecommerceChannel}/stats', [EcommerceChannelController::class, 'stats'])->name('ecommerce.channels.stats')->middleware('check.permission:ecommerce.channels.view');
    });
    ...
    */
    Route::prefix('orders')->group(function () {
        Route::get('/', [EcommerceOrderController::class, 'index'])->name('ecommerce.orders.index')->middleware('check.permission:ecommerce.orders.view');
        Route::get('/stats', [EcommerceOrderController::class, 'stats'])->name('ecommerce.orders.stats')->middleware('check.permission:ecommerce.orders.view');
        ...
        Route::get('/{ecommerceOrder}', [EcommerceOrderController::class, 'show'])->name('ecommerce.orders.show')->middleware('check.permission:ecommerce.orders.view');
    ...
    */
    Route::prefix('payment-gateways')->group(function () {
        Route::get('/', [PaymentGatewayController::class, 'index'])->name('ecommerce.payment-gateways.index')->middleware('check.permission:ecommerce.payment-gateways.view');
        ...
        Route::get('/{paymentGateway}', [PaymentGatewayController::class, 'show'])->name('ecommerce.payment-gateways.show')->middleware('check.permission:ecommerce.payment-gateways.view');
    ...
    */
    Route::prefix('payments')->group(function () {
        Route::get('/', [OnlinePaymentController::class, 'index'])->name('ecommerce.payments.index')->middleware('check.permission:ecommerce.payments.view');
        Route::get('/{onlinePayment}', [OnlinePaymentController::class, 'show'])->name('ecommerce.payments.show')->middleware('check.permission:ecommerce.payments.view');
        Route::get('/{onlinePayment}/status', [OnlinePaymentController::class, 'status'])->name('ecommerce.payments.status')->middleware('check.permission:ecommerce.payments.view');

...
Route::middleware(['auth:api'])->group(function () {
    ...
    */
    Route::prefix('barcodes')->group(function () {
        Route::get('/', [BarcodeController::class, 'index'])->name('inventory.barcodes.index')->middleware('check.permission:inventory.barcodes.view');
        ...
        Route::get('/{barcode}', [BarcodeController::class, 'show'])->name('inventory.barcodes.show')->middleware('check.permission:inventory.barcodes.view');
    ...
    Route::get('products/{product}/barcodes', [BarcodeController::class, 'listForProduct'])->middleware('check.permission:inventory.barcodes.view');
    ...
    */
    Route::prefix('price-check')->group(function () {
        ...
        Route::get('/analytics', [PriceCheckController::class, 'analytics'])->name('inventory.price-check.analytics')->middleware('check.permission:inventory.barcodes.view');
        Route::get('/logs', [PriceCheckController::class, 'logs'])->name('inventory.price-check.logs')->middleware('check.permission:inventory.barcodes.view');

        // Stations
        Route::prefix('stations')->group(function () {
            Route::get('/', [PriceCheckController::class, 'stationIndex'])->name('inventory.price-check.stations.index')->middleware('check.permission:inventory.barcodes.view');
            ...
            Route::get('/{station}', [PriceCheckController::class, 'stationShow'])->name('inventory.price-check.stations.show')->middleware('check.permission:inventory.barcodes.view');
            ...
            Route::get('/{station}/stats', [PriceCheckController::class, 'stationStats'])->name('inventory.price-check.stations.stats')->middleware('check.permission:inventory.barcodes.view');
        });
    });
    ...
    */
    Route::prefix('shelf-labels')->group(function () {
        Route::get('/', [ShelfLabelController::class, 'index'])->name('inventory.shelf-labels.index')->middleware('check.permission:inventory.shelf-labels.view');
        ...
        Route::get('/{shelfLabel}', [ShelfLabelController::class, 'show'])->name('inventory.shelf-labels.show')->middleware('check.permission:inventory.shelf-labels.view');
